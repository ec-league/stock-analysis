                ...
                tooltip={[
                  ...
                  (time, start, end, max, min) => {
                    return {
                      name: time,
                      value:
                        '<br><span style="padding-left: 16px">开盘批核率：' +
                        start +
                        "</span><br/>" +
                        '<span style="padding-left: 16px">收盘批核率：' +
                        end +
                        "</span><br/>" +
                        '<span style="padding-left: 16px">最高批核率：' +
                        max +
                        "</span><br/>" +
                        '<span style="padding-left: 16px">最低批核率：' +
                        min +
                        "</span>"
                    };
                  }
                ...
                tooltip={[
                  ...
                  (time, volumn) => {
                    return {
                      name: time,
                      value:
                        '<br/><span style="padding-left: 16px">进件量：' +
                        volumn +
                        "</span><br/>"
                    };
                  }
...
export default  class GrailStock extends React.Component {
  render() {
