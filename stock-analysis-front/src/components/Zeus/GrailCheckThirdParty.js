...
export default class GrailCheckThirdParty extends React.Component {
  constructor(props) {
    super(props)
  }
  ...
  render() {
    ...
    const legendItems = [
      { value: '查同盾', marker: { symbol: 'square', fill: '#3182bd', radius: 5 } },
      { value: '查百融', marker: { symbol: 'square', fill: '#41a2fc', radius: 5 } },

      { value: '查公安', marker: { symbol: 'hyphen', stroke: '#fad248', radius: 5, lineWidth: 3 } },
    ];
    return (
      <Chart
        ...
        <View data={this.props.data} >
          <Axis name="查公安" position="right" />
          <Geom type="line" position="label*查公安" color="#fad248" size={3} />
        </View>
      </Chart>
    )
  }
